...
const Switch = () => {
    ...
    useEffect(() => {
        ...
        setTheme(savedTheme);
        document.body.className = savedTheme; // Set the initial class
    }, []);
    ...
    const toggleTheme = () => {
        ...
        document.body.className = newTheme; // Apply the class to body
    };
    return (
        <StyledWrapper>
